...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('../front/tailwind.css') }}">
  <script src="https://cdn.tailwindcss.com?plugins=forms,typography,aspect-ratio,line-clamp,container-queries"></script>
  <link href="https://cdn.jsdelivr.net/npm/flowbite@2.5.2/dist/flowbite.min.css"  rel="stylesheet" />

  <title>Si MeTra</title>
...
<body class="antialiased bg-white font-sans text-gray-900">
  ...
  <main class="w-full">
    ...
    <header class="absolute top-0 left-0 w-full z-50 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64">
      ...
      <div class="flex flex-wrap items-center justify-between py-6">
        <div class="w-1/2 md:w-auto">
          <a href="index.html" class="text-white font-bold text-3xl">
            Medical Tracking
          </a>
        </div>
          ...
          <nav
            ...
            <ul class="md:flex items-center">
              ...
              <li class="md:ml-6 mt-3 md:mt-0">
                <button class="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium ring-blue-800 text-gray-900 rounded-lg group hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800" type="button">
                    <span class="relative px-5 py-2.5 transition-all ease-in duration-75 bg-transparent"><ul>Pasien 1</ul></span>
                </button>
              </li>
            </ul>
          </nav>
    ...
    <div class="bg-gray-100">
      <section class="cover bg-blue-teal-gradient relative bg-green-600 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 overflow-hidden py-48 flex
      items-center min-h-screen">
        <div class="h-full absolute top-0 left-0 z-0">
          <img src="{{ asset('../front/images/bg.jpg') }}" alt="" class="w-full h-full object-cover opacity-20">
        </div>

        <div class="lg:w-3/4 xl:w-2/4 relative z-10 h-100 lg:mt-16">
          <div>
            <h1 class="text-white text-4xl md:text-5xl xl:text-6xl font-bold leading-tight">Lacak Perawatan, Cepat pulih.</h1>
            <p class="text-blue-100 text-xl md:text-2xl leading-snug mt-4">Pantau kondisi pasien rawat jalan dengan mudah dan akurat, untuk perawatan yang lebih terarah.</p>
            <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" href="#" class="px-8 py-4 bg-teal-500 text-white rounded inline-block mt-8 font-semibold">Jadwal Temu</button>
          </div>
        </div>
      </section>
    </div>
      ...
      <div class="md:flex md:flex-wrap mt-24 text-center md:-mx-4">
        <div class="md:w-1/2 md:px-4 lg:w-1/4">
          <div class="bg-white rounded-lg border border-gray-300 p-8">
            <img src="{{ asset('../front/images/teeth-whitening.svg') }}" alt="" class="h-20 mx-auto">
        ...
        <div class="md:w-1/2 md:px-4 mt-4 md:mt-0 lg:w-1/4">
          <div class="bg-white rounded-lg border border-gray-300 p-8">
            <img src="{{ asset('../front/images/oral-surgery.svg') }}" alt="" class="h-20 mx-auto">
        ...
        <div class="md:w-1/2 md:px-4 mt-4 md:mt-8 lg:mt-0 lg:w-1/4">
          <div class="bg-white rounded-lg border border-gray-300 p-8">
            <img src="{{ asset('../front/images/painless-dentistry.svg') }}" alt="" class="h-20 mx-auto">
        ...
        <div class="md:w-1/2 md:px-4 mt-4 md:mt-8 lg:mt-0 lg:w-1/4">
          <div class="bg-white rounded-lg border border-gray-300 p-8">
            <img src="{{ asset('../front/images/periodontics.svg') }}" alt="" class="h-20 mx-auto">
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" action="#">
                        <div>
                            ...
                            <input type="text" name="text" id="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="" required value="Pasien 1"/>
                        </div>
                        <div>
                            <label for="text" class="block mb-2 text-sm font-medium text-gray-900 ">Keluhan : </label>
                            <input type="text" name="text" id="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Keluhan yang dirasakan" required />
                        </div>
                        <div>
                            <label for="text" class="block mb-2 text-sm font-medium text-gray-900 ">Aktivitas : </label>
                            <input type="text" name="text" id="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Aktivitas yang dilakukan" required />
                        </div>
                        <div class="mb-4 flex justify-end space-x-4">
                            <div class="flex items-center">
                                <input type="radio" name="tingkat" id="berat" class="mr-1" required>
                                <label for="berat" class="text-sm font-medium text-gray-900">Berat</label>
                            </div>
                            <div class="flex items-center">
                                <input type="radio" name="tingkat" id="sedang" class="mr-1" required>
                                <label for="sedang" class="text-sm font-medium text-gray-900">Sedang</label>
                            </div>
                            <div class="flex items-center">
                                <input type="radio" name="tingkat" id="ringan" class="mr-1" required>
                                <label for="ringan" class="text-sm font-medium text-gray-900">Ringan</label>
                            </div>
                        </div>
                        <div>
                            <label for="text" class="block mb-2 text-sm font-medium text-gray-900 ">Catatan : </label>
                            <input type="text" name="text" id="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Catatan Lain" required />
                        </div>
                        ...
                        <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Kirim Permintaan</button>
