...
<html lang="en">
  ...
  >
    <!-- ===== Preloader Start ===== -->
    <include src="{{ asset('../dashboard/src/partials/preloader.html') }}"></include>
    <!-- ===== Preloader End ===== -->

    <!-- ===== Page Wrapper Start ===== -->
    <div class="flex h-screen overflow-hidden">
      <!-- ===== Sidebar Start ===== -->
      <include src="{{ asset('../dashboard/src/partials/sidebar.html') }}"></include>
      <!-- ===== Sidebar End ===== -->
      ...
      >
        <!-- ===== Header Start ===== -->
        <include src="{{ asset('../dashboard/src/partials/header.html') }}" />
        <!-- ===== Header End ===== -->
        ...
        <main>
          <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            >
              <!-- ====== Chart One Start -->
              <include src="{{ asset('../dashboard/src/partials/chart-01.html') }}" />
              <!-- ====== Chart One End -->

              <!-- ====== Chart Two Start -->
              <include src="{{ asset('../dashboard/src/partials/chart-02.html') }}" />
              <!-- ====== Chart Two End -->

              <!-- ====== Chart Three Start -->
              <include src="{{ asset('../dashboard/src/partials/chart-03.html') }}" />
              <!-- ====== Chart Three End -->

              <!-- ====== Map One Start -->
              <include src="{{ asset('../dashboard/src/partials/map-01.html') }}" />
              <!-- ====== Map One End -->

              <!-- ====== Table One Start -->
              <div class="col-span-12 xl:col-span-8">
                <include src="{{ asset('../dashboard/src/partials/table-01.html') }}" />
              </div>
              <!-- ====== Table One End -->
                ...
                <div>
                  ...
                  >
                    <div class="relative h-14 w-14 rounded-full">
                      <img src="{{ asset('../dashboard/src/images/user/user-03.png') }}" alt="User" />
                      <span
                  ...
                  >
                    <div class="relative h-14 w-14 rounded-full">
                      <img src="{{ asset('../dashboard/src/images/user/user-04.png') }}" alt="User" />
                      <span
                        class="absolute bottom-0 right-0 h-3.5 w-3.5 rounded-full border-2 border-white bg-meta-3"
                      ></span>
                    </div>
                  ...
                  >
                    <div class="relative h-14 w-14 rounded-full">
                      <img src="{{ asset('../dashboard/src/images/user/user-05.png') }}" alt="User" />
                      <span
                  ...
                  >
                    <div class="relative h-14 w-14 rounded-full">
                      <img src="{{ asset('../dashboard/src/images/user/user-01.png') }}" alt="User" />
                      <span
                        class="absolute bottom-0 right-0 h-3.5 w-3.5 rounded-full border-2 border-white bg-meta-3"
                      ></span>
                    </div>
                  ...
                  >
                    <div class="relative h-14 w-14 rounded-full">
                      <img src="{{ asset('../dashboard/src/images/user/user-02.png') }}" alt="User" />
                      <span
